...
const (
	configPath = "/opt/gopath/src/github.com/hyperledger/fabric-sdk-go/test/fixtures/config/config_test.yaml"
	//entityMatcherLocal config file containing entity matchers for local test
	entityMatcherLocal = "/opt/gopath/src/github.com/hyperledger/fabric-sdk-go/test/fixtures/config/overrides/local_entity_matchers.yaml"
	//ConfigPathSingleOrg single org version of 'configPath' for testing discovery
	ConfigPathSingleOrg = "/opt/gopath/src/github.com/hyperledger/fabric-sdk-go/test/fixtures/config/config_e2e_single_org.yaml"
)
